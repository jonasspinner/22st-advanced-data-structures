...
BENCHMARK(BM_InsertN<ads::NaiveDynamicBitVector>)->Arg(1 << 5)->Arg(1024)->Arg(1 << 15);
BENCHMARK(BM_InsertN<ads::DynamicBitVector<uint8_t, 2>>)->Arg(1 << 5)->Arg(1024)->Arg(1 << 15);
BENCHMARK(BM_InsertN<ads::DynamicBitVector<uint64_t, 2>>)->Arg(1 << 5)->Arg(1024)->Arg(1 << 15);
BENCHMARK(BM_InsertN<ads::DynamicBitVector<uint64_t, 4>>)->Arg(1 << 5)->Arg(1024)->Arg(1 << 15);
BENCHMARK(BM_InsertN<ads::DynamicBitVector<uint64_t, 16>>)->Arg(1 << 5)->Arg(1024)->Arg(1 << 15);
BENCHMARK(BM_InsertN<ads::DynamicBitVector<uint64_t, 64>>)->Arg(1 << 5)->Arg(1024)->Arg(1 << 15);
...
BENCHMARK(BM_Insert<ads::DynamicBitVector<uint8_t, 256>>)->RangeMultiplier(2)->Range(8, 1 << 22);
...
BENCHMARK(BM_Insert<ads::DynamicBitVector<uint64_t, 256>>)->RangeMultiplier(2)->Range(8, 1 << 24);
BENCHMARK(BM_Insert<ads::DynamicBitVector<uint64_t, 1024>>)->RangeMultiplier(2)->Range(8, 1 << 24);
...
BENCHMARK(BM_Remove<ads::DynamicBitVector<uint8_t, 256>>)->RangeMultiplier(2)->Range(8, 1 << 22);
...
BENCHMARK(BM_Remove<ads::DynamicBitVector<uint64_t, 256>>)->RangeMultiplier(2)->Range(8, 1 << 24);
BENCHMARK(BM_Remove<ads::DynamicBitVector<uint64_t, 1024>>)->RangeMultiplier(2)->Range(8, 1 << 24);
...
BENCHMARK(BM_RemoveMid<ads::DynamicBitVector<uint8_t, 256>>)->RangeMultiplier(2)->Range(8, 1 << 22);
...
BENCHMARK(BM_RemoveMid<ads::DynamicBitVector<uint64_t, 256>>)->RangeMultiplier(2)->Range(8, 1 << 24);
BENCHMARK(BM_RemoveMid<ads::DynamicBitVector<uint64_t, 1024>>)->RangeMultiplier(2)->Range(8, 1 << 24);
...
BENCHMARK(BM_Rank<ads::DynamicBitVector<uint8_t, 256>>)->RangeMultiplier(2)->Range(8, 1 << 22);
...
BENCHMARK(BM_Rank<ads::DynamicBitVector<uint64_t, 256>>)->RangeMultiplier(2)->Range(8, 1 << 24);
BENCHMARK(BM_Rank<ads::DynamicBitVector<uint64_t, 1024>>)->RangeMultiplier(2)->Range(8, 1 << 24);
...
BENCHMARK(BM_Select<ads::DynamicBitVector<uint64_t, 256>>)->RangeMultiplier(2)->Range(8, 1 << 24);
BENCHMARK(BM_Select<ads::DynamicBitVector<uint64_t, 1024>>)->RangeMultiplier(2)->Range(8, 1 << 24);
