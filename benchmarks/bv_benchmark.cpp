...
BENCHMARK(BM_Insert<ads::NaiveDynamicBitVector>)->Arg(1 << 5)->Arg(1 << 10)->Arg(1 << 15);
BENCHMARK(BM_Insert<ads::DynamicBitVector<uint8_t, 2>>)->Arg(1 << 5)->Arg(1 << 10)->Arg(1 << 15);
BENCHMARK(BM_Insert<ads::DynamicBitVector<uint64_t, 2>>)->Arg(1 << 5)->Arg(1 << 10)->Arg(1 << 15);
BENCHMARK(BM_Insert<ads::DynamicBitVector<uint64_t, 4>>)->Arg(1 << 5)->Arg(1 << 10)->Arg(1 << 15);
BENCHMARK(BM_Insert<ads::DynamicBitVector<uint64_t, 8>>)->Arg(1 << 5)->Arg(1 << 10)->Arg(1 << 15);
BENCHMARK(BM_Insert<ads::DynamicBitVector<uint64_t, 16>>)->Arg(1 << 5)->Arg(1 << 10)->Arg(1 << 15);
